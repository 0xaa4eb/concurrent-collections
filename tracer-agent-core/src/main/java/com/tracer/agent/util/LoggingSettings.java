...
public class LoggingSettings {
    ...
    public static final String LOG_LEVEL_PROPERTY = "tracer.org.slf4j.simpleLogger.defaultLogLevel";
    public static final String SHOW_DATETIME_PROPERTY = "tracer.org.slf4j.simpleLogger.showDateTime";
    ...
    static {
        ...
        if (defaultLogging) {
            logger.info("Tracer logging is enabled. One can disable it with {}", ("-D" + LOG_LEVEL_PROPERTY + "=OFF"));
        }
